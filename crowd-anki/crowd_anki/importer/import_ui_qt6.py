...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.cb_notes_html = QtWidgets.QCheckBox(parent=self.group_deck_import)
        self.cb_notes_html.setObjectName("cb_notes_html")
        self.verticalLayout_7.addWidget(self.cb_notes_html)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.cb_notes_html.setText(_translate("Dialog", "Notes (HTML Cards)"))
